...
Run this before any `databricks` CLI or SDK operation.
...
**PRCS_NM naming:**
- Pre-val: `EDP_PRE_VLD_V2_{TABLE_SUFFIX}` e.g. `EDP_PRE_VLD_V2_SOURCE_MOTOR_DEVTEST`
...
- **Pre-val config must exist before running:** check `CHV_CONFIG_PRE_VALIDATION_V2` has entries for the table
